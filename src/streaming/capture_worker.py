...
from src.streaming.stream_capture import StreamCapture
# from capture.FFmpegCapture import FFmpegStreamCapture as ImprovedStreamCapture
from src.streaming.motion_detector import MotionDetection
from src.streaming.capture_utils import safe_put_queue, downscale_bgr, to_gray
...
def capture_worker(
    ...
    """
    Per-stream worker that captures frames, runs motion objectdetectors, and pushes frames to queue.
